...
def main():
    ...
    parser.add_argument("--name", default="_random_user_999_",
    ...
    subparsers = parser.add_subparsers(
        title="Subcommands", required=True, help="The subcommands provided by the tool")
    analyse.setup_parser(subparsers.add_parser(
        "analyse", help="Fetches all followers and following from the target and determines which of them don't follow back"))
    login.setup_parser(subparsers.add_parser(
